...
- (void)buildTableView
{
    _tabelView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0,ScreenWidth , ScreenHeight - 114 - kBottom_Height)];
...
- (void)buildToolBar
{
    ZQMusicListToolBar *ToolBar = [[ZQMusicListToolBar alloc] initWithFrame:CGRectMake(0, ScreenHeight - 114 - kBottom_Height, ScreenWidth, 50)];
