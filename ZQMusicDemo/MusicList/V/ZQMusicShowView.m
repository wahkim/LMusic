...
//    self.backBtn.frame.origin.y = self.backBtn.frame.origin.y + kTop_Height;

//    self.backBtn.frame = CGRectMake(15, 15 + kTop_Height, 40, 40);
    
    self.lrcScrollView.backgroundColor = [UIColor blackColor];
